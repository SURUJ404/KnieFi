...
function setThemeVariables(_themeVariables) {
  ...
  if (themeTag && darkModeTag && lightModeTag) {
    ...
    if (fontFamily2) {
      themeTag.textContent = (_a3 = themeTag.textContent) == null ? void 0 : _a3.replace("font-family: KHTeka", `font-family: ${fontFamily2}`);
...
var UiHelperUtil = {
  ...
  getColorTheme(theme) {
    ...
    if (theme) {
      ...
      if ((_a3 = window.matchMedia("(prefers-color-scheme: dark)")) == null ? void 0 : _a3.matches) {
        return "dark";
      }
      return "light";
    }
...
var TransactionUtil = {
  ...
  getTransactionImageURL(transfer) {
    ...
    if (transfer && isNFT) {
      imageURL = (_c = (_b2 = (_a3 = transfer == null ? void 0 : transfer.nft_info) == null ? void 0 : _a3.content) == null ? void 0 : _b2.preview) == null ? void 0 : _c.url;
  ...
  getTransactionDescriptions(transaction, mergedTransfers) {
    var _a3;
    const type = (_a3 = transaction == null ? void 0 : transaction.metadata) == null ? void 0 : _a3.operationType;
  ...
  mergeTransfers(transfers) {
    ...
    const mergedTransfers = filteredTransfers.reduce((acc, t) => {
      var _a3;
      const name = (_a3 = t == null ? void 0 : t.fungible_info) == null ? void 0 : _a3.name;
  ...
  filterGasFeeTransfers(transfers) {
    const tokenGroups = transfers == null ? void 0 : transfers.reduce((groups, transfer) => {
      var _a3;
      const tokenName = (_a3 = transfer == null ? void 0 : transfer.fungible_info) == null ? void 0 : _a3.name;
      if (tokenName) {
        if (!groups[tokenName]) {
          groups[tokenName] = [];
        }
    ...
    transfers == null ? void 0 : transfers.forEach((transfer) => {
      var _a3;
      if (!((_a3 = transfer == null ? void 0 : transfer.fungible_info) == null ? void 0 : _a3.name)) {
...
// node_modules/@reown/appkit-ui/dist/esm/src/assets/svg/tron.js
var tronSvg = svg`
...
var phosphorImports = {
  "ph-arrow-circle-down": () => import("./PhArrowCircleDown-4JNDAGEM.js"),
  "ph-arrow-clockwise": () => import("./PhArrowClockwise-2FIPQ5D5.js"),
  "ph-arrow-down": () => import("./PhArrowDown-HMZEOXC2.js"),
  "ph-arrow-left": () => import("./PhArrowLeft-42JSK3GX.js"),
  "ph-arrow-right": () => import("./PhArrowRight-WCXG3TJR.js"),
  "ph-arrow-square-out": () => import("./PhArrowSquareOut-MTTK5YZ4.js"),
  "ph-arrows-down-up": () => import("./PhArrowsDownUp-NVLCS4VY.js"),
  "ph-arrows-left-right": () => import("./PhArrowsLeftRight-44EWWZWK.js"),
  "ph-arrow-up": () => import("./PhArrowUp-WLLSS45G.js"),
  "ph-arrow-up-right": () => import("./PhArrowUpRight-DGD7WE5E.js"),
  "ph-arrows-clockwise": () => import("./PhArrowsClockwise-RZWOY4MI.js"),
  "ph-bank": () => import("./PhBank-AX7LPDSW.js"),
  "ph-browser": () => import("./PhBrowser-5LVS42XY.js"),
  "ph-caret-down": () => import("./PhCaretDown-XRRPOB44.js"),
  "ph-caret-left": () => import("./PhCaretLeft-YBJY72UH.js"),
  "ph-caret-right": () => import("./PhCaretRight-4NCQEUGQ.js"),
  "ph-caret-up": () => import("./PhCaretUp-NUF2QAWW.js"),
  "ph-check": () => import("./PhCheck-LF7LPROF.js"),
  "ph-circle-half": () => import("./PhCircleHalf-2CRDIPVS.js"),
  "ph-clock": () => import("./PhClock-YD3BB2L2.js"),
  "ph-compass": () => import("./PhCompass-IPCPJ2ZT.js"),
  "ph-copy": () => import("./PhCopy-FCZO5GOF.js"),
  "ph-credit-card": () => import("./PhCreditCard-SBSDMSBD.js"),
  "ph-currency-dollar": () => import("./PhCurrencyDollar-WF2T7QPK.js"),
  "ph-desktop": () => import("./PhDesktop-GMEM2HIF.js"),
  "ph-device-mobile": () => import("./PhDeviceMobile-GLVUKQA4.js"),
  "ph-dots-three": () => import("./PhDotsThree-R5NPUZEA.js"),
  "ph-vault": () => import("./PhVault-DGWGXEBO.js"),
  "ph-envelope": () => import("./PhEnvelope-XVRNK4KL.js"),
  "ph-funnel-simple": () => import("./PhFunnelSimple-7VXPHE53.js"),
  "ph-globe": () => import("./PhGlobe-XTW5DR2Q.js"),
  "ph-identification-card": () => import("./PhIdentificationCard-ED6KDCIN.js"),
  "ph-image": () => import("./PhImage-RHGJBISF.js"),
  "ph-info": () => import("./PhInfo-3NM6UJ33.js"),
  "ph-lightbulb": () => import("./PhLightbulb-RPGDA256.js"),
  "ph-magnifying-glass": () => import("./PhMagnifyingGlass-OGD5QEMW.js"),
  "ph-paper-plane-right": () => import("./PhPaperPlaneRight-L5YGOUJ6.js"),
  "ph-plus": () => import("./PhPlus-ISEHBZKI.js"),
  "ph-power": () => import("./PhPower-GUVOGXMS.js"),
  "ph-puzzle-piece": () => import("./PhPuzzlePiece-5OVW64IV.js"),
  "ph-qr-code": () => import("./PhQrCode-Z77UO6IC.js"),
  "ph-question": () => import("./PhQuestion-IPU4AYEE.js"),
  "ph-question-circle": () => import("./PhQuestionMark-7ED3CMBZ.js"),
  "ph-seal-check": () => import("./PhSealCheck-GDBU4JD7.js"),
  "ph-sign-out": () => import("./PhSignOut-XQYVPX3Q.js"),
  "ph-spinner": () => import("./PhSpinner-HQUOK5TT.js"),
  "ph-trash": () => import("./PhTrash-6TY5IMRR.js"),
  "ph-user": () => import("./PhUser-HKFKDUS7.js"),
  "ph-wallet": () => import("./PhWallet-RPRB3B2H.js"),
  "ph-warning": () => import("./PhWarning-YOWAWITT.js"),
  "ph-warning-circle": () => import("./PhWarningCircle-S6RCWGWF.js"),
  "ph-x": () => import("./PhX-LQ6TJ4A3.js")
};
var svgOptions = {
...
var WuiIcon = class WuiIcon2 extends LitElement {
  ...
  render() {
    ...
    if (phosphorIconTag && phosphorIconTag !== "") {
      ...
      return html2`<${tag2} size=${ifDefined(getPhosphorSize[this.size])} weight="${this.weight}"></${tag2}>`;
    }
...
lit-html/development/static.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-6MOEFUFX.js.map
