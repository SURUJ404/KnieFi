...
var ApiController = {
  ...
  async fetchWallets(params) {
    ...
    const wallets = await api3.get({
      ...
      params: {
        ...
        include: ((_a2 = params.include) == null ? void 0 : _a2.join(",")) || void 0,
  ...
  async searchWallet({ search, badge, entries: entriesOverride, page: pageOverride, include: includeOverride, exclude: excludeOverride }) {
    ...
    const params = {
      ...
      search: (search == null ? void 0 : search.trim()) || void 0,
      badge_type: badge,
      include: includeOverride ?? includeWalletIds,
...
var ConnectorUtil = {
  ...
  showConnector(connector) {
    ...
    if (isFilterableConnectorType) {
      const connectorWalletId = connector.explorerId || ((_b = connector.explorerWallet) == null ? void 0 : _b.id);
      if ((excludeWalletIds == null ? void 0 : excludeWalletIds.length) && connectorWalletId && excludeWalletIds.includes(connectorWalletId)) {
        return false;
      }
      if ((includeWalletIds == null ? void 0 : includeWalletIds.length) && (!connectorWalletId || !includeWalletIds.includes(connectorWalletId))) {
        return false;
      }
    }
    return true;
...
var controller9 = {
  ...
  getSdkEventProperties(error) {
    ...
    return {
      ...
      amount: Number(state17.sendTokenAmount ?? "0"),
...
buffer/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-OVYARHNG.js.map
