import {
  ...
  AppKitConnectButton,
  AppKitNetworkButton
} from "./chunk-SVDN3GBS.js";
import "./chunk-ZV36QEKU.js";
import "./chunk-ZA4H33FI.js";
import "./chunk-TWWANP2M.js";
import "./chunk-5I5BMTEK.js";
import "./chunk-ELYWBBBL.js";
import "./chunk-KIWIQOBC.js";
import "./chunk-WVYNTO7U.js";
import "./chunk-RUF2NKMN.js";
import "./chunk-ZIPE34MD.js";
import "./chunk-6QOWD2HI.js";
import "./chunk-BJMIUKBU.js";
import "./chunk-BRVP2TJN.js";
import "./chunk-GDTOH6OS.js";
import "./chunk-ZMHK5BKH.js";
import "./chunk-XI67MHBF.js";
import "./chunk-LD4QFRZW.js";
import "./chunk-IT3LPSSX.js";
import "./chunk-IEIX4SWM.js";
import "./chunk-KFIR2UEK.js";
import "./chunk-HHMYR65P.js";
import "./chunk-ACKBLWFT.js";
import "./chunk-HNB35IZC.js";
import "./chunk-X2FUQGJE.js";
import "./chunk-IQI7PFJB.js";
import "./chunk-FS3CSUOV.js";
import "./chunk-KPHCIHLL.js";
import "./chunk-CMXENSFA.js";
import "./chunk-CGXHVTOC.js";
import "./chunk-D56SXU4K.js";
import "./chunk-XJPE6WJY.js";
import "./chunk-RKVMDDI4.js";
import {
  setColorTheme,
  setThemeVariables
} from "./chunk-6MOEFUFX.js";
import {
  W3mFrameProviderSingleton
} from "./chunk-MUEV6S3V.js";
import {
  CaipNetworksUtil,
...
import {
  ...
  WcHelpersUtil
} from "./chunk-DFAZJ2GF.js";
import "./chunk-GJBZJ4UL.js";
import "./chunk-DH2S55CW.js";
import {
  AdapterController,
  ApiController,
  AssetController,
  ...
  snapshot,
  subscribe
} from "./chunk-OVYARHNG.js";
import "./chunk-ANJCMEYS.js";
import "./chunk-H43UQQNF.js";
import {
  ConstantsUtil,
  NetworkUtil,
  ParseUtil,
...
import "./chunk-MZYXOCVJ.js";
import "./chunk-U7IJITDK.js";
import "./chunk-XOVIEHUS.js";
import {
  toHex
} from "./chunk-S32A63FN.js";
import "./chunk-TICGCDEG.js";
import "./chunk-36HHBNGG.js";
import {
  __toESM
...
function useAppKitNetworkCore() {
  ...
  const networkState = activeChain ? (_a = chains.get(activeChain)) == null ? void 0 : _a.networkState : void 0;
  return {
    ...
    approvedCaipNetworkIds: networkState == null ? void 0 : networkState.approvedCaipNetworkIds,
    supportsAllNetworks: (networkState == null ? void 0 : networkState.supportsAllNetworks) ?? true
  };
}
...
var UniversalAdapter = class extends AdapterBlueprint {
  ...
  async switchNetwork(params) {
    ...
    (_g = connector.provider) == null ? void 0 : _g.setDefaultChain(caipNetwork.caipNetworkId);
  }
...
var AppKitBaseClient = class {
  ...
  async initialize(options) {
    ...
    if (((_e = OptionsController.state.features) == null ? void 0 : _e.reownAuthentication) || ((_f = OptionsController.state.remoteFeatures) == null ? void 0 : _f.reownAuthentication)) {
      const { ReownAuthentication } = await import("./features-5EEH5Q4G.js");
  ...
  syncConnectedWalletInfo(chainNamespace) {
    ...
    if (providerType === ConstantsUtil3.CONNECTOR_TYPE_ANNOUNCED || providerType === ConstantsUtil3.CONNECTOR_TYPE_INJECTED) {
      ...
      if (connectorId === ConstantsUtil.CONNECTOR_ID.COINBASE_SDK || connectorId === ConstantsUtil.CONNECTOR_ID.COINBASE || connectorId === ConstantsUtil.CONNECTOR_ID.BASE_ACCOUNT) {
        const connector = this.getConnectors().find((c) => c.id === connectorId);
        const defaultName = connectorId === ConstantsUtil.CONNECTOR_ID.BASE_ACCOUNT ? "Base Account" : "Coinbase Wallet";
        const name = (connector == null ? void 0 : connector.name) || defaultName;
...
var AppKit = class extends AppKitBaseClient {
  ...
  async loadModalComponents(features, remoteFeatures) {
    ...
    if (usingEmbeddedWallet) {
      featureImportPromises.push(import("./embedded-wallet-L633IHD7.js"));
    }
    if (remoteFeatures.email) {
      featureImportPromises.push(import("./email-6XO3R6K7.js"));
    }
    if (remoteFeatures.socials) {
      featureImportPromises.push(import("./socials-ZT3TYWDP.js"));
    }
    if (remoteFeatures.swaps && remoteFeatures.swaps.length > 0) {
      featureImportPromises.push(import("./swaps-WX7HWDEB.js"));
    }
    if (features.send) {
      featureImportPromises.push(import("./send-IO3K3JEL.js"));
    }
    if (features.receive) {
      featureImportPromises.push(import("./receive-UPUE6KUE.js"));
    }
    if (remoteFeatures.onramp && remoteFeatures.onramp.length > 0) {
      featureImportPromises.push(import("./onramp-BKF5X6V5.js"));
    }
    if (remoteFeatures.payWithExchange) {
      featureImportPromises.push(import("./pay-with-exchange-NABBRRTQ.js"));
    }
    if (remoteFeatures.activity) {
      featureImportPromises.push(import("./transactions-NYDP6ARR.js"));
    }
    if (features.pay || remoteFeatures.payments) {
      featureImportPromises.push(import("./exports-WRC7UCAS.js"));
    }
    if (remoteFeatures.emailCapture) {
      featureImportPromises.push(import("./data-capture-OICDFLOY.js"));
    }
    await Promise.all([
      ...featureImportPromises,
      import("./exports-H3D5JKJY.js"),
      import("./w3m-modal-W5T76CBI.js")
    ]);
  }
};
...
function useAppKitNetwork() {
  const { caipNetwork, caipNetworkId, chainId, approvedCaipNetworkIds, supportsAllNetworks } = useAppKitNetworkCore();
